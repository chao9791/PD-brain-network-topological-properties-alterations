...
library(pacman)
pacman::p_load(readxl,dmetar,clipr,dplyr,brms,ggplot2,tibble,metafor,broom,tidybayes,
               ggridges, googledrive,tidyr, data.table,cowplot,PerformanceAnalytics,
               extrafont,scales,showtext,colorspace,glue,purrr,ggbeeswarm,chaoxi,stringr)
...
categorical_vars = c("Drug_code","Direction_code", "Template_AAL","Template_cerebellum","Tractography_code","Edges.weighting_code", "Threshold_code")
...
##Categorical variable
categorical_vars = c("Drug_code", "Scanning", "Template_code","Network_framework", "GSR", "Threshold_code")
data=process_categorical_vars(categorical_vars, data)
...
# ##error for fmri strength drug for robust,may due to small effect size,remove
# 
# #results[[2]][[14]]=results[[2]][[14]][-10]
# 
# results[["fMRI"]][["Strength"]] = results[["fMRI"]][["Strength"]][!names(results[["fMRI"]][["Strength"]]) %in% "drug"]
# 
# 
# 
# results.r <- list()
